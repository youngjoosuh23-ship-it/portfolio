  ...
  return (
    <html lang="ko" className={`${geistMono.variable} h-full`}>
      <head>
        ...
        />
        <Script src="https://www.googletagmanager.com/gtag/js?id=G-286KNP67NQ" strategy="afterInteractive" />
        <Script id="ga4-init" strategy="afterInteractive" dangerouslySetInnerHTML={{
          __html: `window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','G-286KNP67NQ');`,
        }} />
      </head>

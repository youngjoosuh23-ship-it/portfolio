export const metadata = {
  title: "Why drug development takes over 10 years?",
  date: "2026-08-04",
...
<img src="/blog/cld/1.png" alt="Why does drug development take 10+ years?" style={{width: "100%", borderRadius: "8px"}} />

## 서론: 신약 개발, 왜 10년이 넘게 걸릴까?

새로운 약 하나가 세상에 나와 환자에게 전달되기까지는 평균 10~15년의 시간과 큰 비용이 소모됩니다.

신약 개발은 크게 **후보물질 발견 → 전임상 → 임상시험(1~3상) → 승인 및 상용화**의 엄격한 단계를 거칩니다. 이 중에서도 특히 바이오의약품(Biologics) 개발에서 초반 발목을 잡는 핵심 병목 구간이 존재하는데, 바로 **세포주 개발(Cell Line Development, CLD)** 단계입니다.

<img src="/blog/cld/2.png" alt="From Lab to Patient: The Drug Development Journey" style={{width: "100%", borderRadius: "8px"}} />
...
<img src="/blog/cld/3.png" alt="Time consuming process: Cell Line Development" style={{width: "100%", borderRadius: "8px"}} />
...
<img src="/blog/cld/4.png" alt="WHY CLD needs to be automated" style={{width: "100%", borderRadius: "8px"}} />
...
<img src="/blog/cld/5.png" alt="Sartorius CLD Automation Ecosystem" style={{width: "100%", borderRadius: "8px"}} />
